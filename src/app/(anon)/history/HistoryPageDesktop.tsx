...
export function HistoryPageDesktop(props: HistoryPageProps) {
  return (
    <div className="flex h-full min-h-0 w-full flex-row">
      ...
      <HistoryListSection
        {...props}
        asideClassName="flex min-h-0 w-80 shrink-0 flex-col border-r border-zinc-300 bg-zinc-50/50 dark:border-zinc-600 dark:bg-zinc-900/50"
      />

      <HistoryDetailSection
        selectedItem={props.selectedItem}
        emptyStateMessage="왼쪽 목록에서 항목을 선택하면 생성된 글이 여기에 표시됩니다."
      />
    </div>
  );
}
