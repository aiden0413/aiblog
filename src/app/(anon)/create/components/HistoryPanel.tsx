  ...
  return (
    <>
      ...
      <div
        ...
        className="fixed right-0 z-[80] w-full max-w-[280px] border-l border-zinc-200 bg-white dark:border-zinc-700 dark:bg-zinc-900 top-20 bottom-[4.5rem] min-[900px]:bottom-0"
        style={{
