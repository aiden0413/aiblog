...
${bodyHtml}
  ...
  return (
    <section className="flex-1 min-w-0 min-h-0 flex flex-col overflow-x-hidden bg-zinc-50 dark:bg-zinc-950 relative min-[900px]:h-full max-h-[calc(100vh-81px-120px)] min-[900px]:max-h-none">
      {copiedLabel !== null && (
